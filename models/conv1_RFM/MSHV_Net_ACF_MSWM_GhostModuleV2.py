...
from models.conv1.GhostModuleV2 import GhostModuleV2
...
class MSHV_Net(nn.Module):
    ...
    def __init__(self, num_classes=1, input_channels=3, c_list=[8, 16, 24, 32, 48, 64],
        ...
        self.encoder2 = nn.Sequential(
            ...
            GhostModuleV2(c_list[0], c_list[1])
        )
        self.encoder3 = nn.Sequential(
            # nn.Conv2d(c_list[1], c_list[2], 3, stride=1, padding=1),
            GhostModuleV2(c_list[1], c_list[2])
        ...
        self.decoder4 = nn.Sequential(
            ...
            GhostModuleV2(c_list[2], c_list[1])

        )
        self.decoder5 = nn.Sequential(
            # nn.Conv2d(c_list[1], c_list[0], 3, stride=1, padding=1),
            GhostModuleV2(c_list[1], c_list[0])
