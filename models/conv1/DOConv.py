...
class DOConv2d(Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=1, D_mul=None, stride=1,
...
if __name__ == '__main__':
    input_2d = torch.randn(1, 8, 64, 64)
    print(input_2d.shape)
    model = DOConv2d(in_channels=8, out_channels=1, kernel_size=1)
