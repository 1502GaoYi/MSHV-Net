...
class EnhancedPartialConv2d(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1, padding=0, n_div=2, bias=False,
                 method='split_cat'):
        super().__init__()
...
if __name__ == '__main__':
    ...
    model = EnhancedPartialConv2d(in_channels=16, out_channels=48, kernel_size=3, stride=1, padding=1, n_div=2, bias=False,
                                  method='split_cat')
    output = model(x)
