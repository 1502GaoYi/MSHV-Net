# ---------------------------------------
# 论文:MobileViT: Light-weight, General-purpose, and Mobile-friendly Vision Transformer (iclr 2022)
# ---------------------------------------
...
if __name__ == '__main__':
    block = MobileViTAttention(in_channel=32,dim=32).cuda()
    input = torch.rand(1, 32, 56, 56).cuda()
    output = block(input)
